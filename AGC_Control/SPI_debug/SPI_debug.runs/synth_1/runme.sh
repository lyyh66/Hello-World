...
HD_PWD='D:/project/SPI_debug/SPI_debug.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_spi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_spi.tcl
